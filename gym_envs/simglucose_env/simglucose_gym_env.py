...
class T1DSimEnv(gym.Env):
    ...
    A wrapper of simglucose.simulation.env.T1DSimEnv to support gym API
        Original T1DSimEnv source code can be found at: 
        - https://github.com/jxx123/simglucose/blob/master/simglucose/envs/simglucose_gym_env.py#L19
        - https://github.com/jxx123/simglucose/blob/master/simglucose/simulation/env.py#L36
    '''
    metadata = {'render.modes': ['human']}

    def __init__(self,patient_name=None,reward_fun=None,scen=None,start_time=None,sensor_name=None,pump_name=None): #, scenario_tup=None, startTime=None
        '''
        ...
        scenario = CustomScenario(start_time=start_time, scenario=scen)#RandomScenario(start_time=start_time, seed=seeds[2]) 
